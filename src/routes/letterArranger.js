...
export class LetterArranger extends React.Component{
  ...
  render(){
    return(
      <div className='w-full grid justify-items-center content-center h-full gap-3 select-none'>
        <div className='p-6 grid justify-items-center align-middle w-1/3 bg-gray-50 gap-3 rounded outline outline-black'>
