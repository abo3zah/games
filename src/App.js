...
import arabicLetters from './routeSVGs/Arabic-Letters.svg';
import countriesFlags from './routeSVGs/Countries-Flag.svg';
        ...
        <div className="w-full h-full bg-slate-100">
            ...
            <div className="p-6 flex flex-wrap gap-5">
                ...
                <Link
                    to="/Letter-Arranger"
                    className="grid justify-items-center">
                    <img src={arabicLetters} className="App-logo" alt="logo" />
                    <span className="text-center font-bold">ترتيب الأحرف</span>
                </Link>
                <Link
                    to="/Countries-Flags"
                    className="grid justify-items-center">
                    <img src={countriesFlags} className="App-logo" alt="logo" />
                    <span className="text-center font-bold">أعلام الدول</span>
                </Link>
            </div>
        </div>
    );
